...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinearLayout = __webpack_require__(2);
	var ViewPort = __webpack_require__(1);
	var Splitter = __webpack_require__(3);
	
	React.renderComponent(new ViewPort({}, new LinearLayout({ orientation: "horizontal" }, [
	    React.DOM.img({ flex: "1", src: "http://www.topoboi.com/pic/201307/1920x1080/topoboi.com-1637.jpg" }, null),
	    new Splitter(null, null),
	    React.DOM.img({ flex: "3", src: "http://www.anypics.ru/pic/201210/1920x1080/anypics.ru-17805.jpg" }, null),
	    new Splitter(null, null),
	    new LinearLayout({ flex: "1", orientation: "vertical" }, [
	        React.DOM.img({ flex: "1", src: "http://img1.liveinternet.ru/images/attach/b/3/7/54/7054370_cats0007wp.jpg" }, null),
	        new Splitter(null, null),
	        React.DOM.img({ flex: "1", src: "http://s47.radikal.ru/i115/1306/5b/8e31eb6df794.jpg" }, null)
	    ])
	])), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {var __extends = this.__extends || function (d, b) {
	...
	//todo переписать view port так чтобы он работал как rendercomponent
	var ViewPort = (function (_super) {
	    __extends(ViewPort, _super);
	    function ViewPort() {
	        _super.apply(this, arguments);
	    }
	    //TODO некорректно возвращает высоту
	    ViewPort.prototype.getClientHeight = function () {
	        var height = document.compatMode == 'CSS1Compat' && !window["opera"] ? document.documentElement.clientHeight : document.body.clientHeight;
	        return height;
	    };
	
	    ViewPort.prototype.componentWillMount = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinearLayout = (function (_super) {
	    ...
	    LinearLayout.getDefaultProps = function () {
	        return {
	    ...
	    LinearLayout.prototype.getDirection = function () {
	        var direction = "row";
	    ...
	    LinearLayout.prototype.render = function () {
	        var _this = this;
	        this.props.children.forEach(function (item, count) {
	            if (item.type.isLayoutSplitter) {
	                item.props.layoutLink = _this;
	                if (count > 0 && count < _this.props.children.length) {
	                    item.props.leftLink = _this.props.children[count - 1];
	                    item.props.rightLink = _this.props.children[count + 1];
	                }
	            } else {
	                item.props.style = item.props.style || { border: "solid 1px black" };
	                if (item.props.flex)
	                    item.props.style.flex = item.props.style.flex || item.props.flex;
	                if (item.props.width)
	                    item.props.style.width = item.props.style.width || item.props.width;
	                if (item.props.height)
	                    item.props.style.height = item.props.style.height || item.props.height;
	            }
	        });
	        ...
	        return React.DOM.div({
	            style: {
	                "flex": "1",
	                "display": "flex",
	                "flex-direction": this.getDirection(),
	                "user-select": "none",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Splitter = (function (_super) {
	    ...
	    Splitter.prototype.getInitialState = function () {
	        return {
	            isDrag: false
	        };
	    };
	    ...
	    *
	    */
	    Splitter.prototype.getImmediateEnvironment = function (el) {
	        //console.log(,target.nextSibling); /*this.getDOMNode()*/
	        var side1Node = el.previousSibling, side2Node = el.nextSibling, side1 = {
	            node: side1Node,
	    ...
	    Splitter.prototype.onDragStart = function (e) {
	    ...
	    Splitter.prototype.onDragEnd = function (e) {
	    ...
	    Splitter.prototype.onDrag = function (e) {
	        var leftSideFlex, rightSideFlex, upSideFlex, downSideFlex, offsetX = e.screenX - this.startX, offsetY = e.screenY - this.startY, side1, side2, sumFlex;
	    ...
	    Splitter.prototype.componentWillMount = function () {
	    ...
	    Splitter.prototype.render = function () {
	        var width = "", height = "";
	        if (this.props.layoutLink.props.orientation == "horizontal") {
	            var width = "5px";
	        } else {
	            height = "5px";
	        }
	    ...
	    Splitter.isLayoutSplitter = true;
	    return Splitter;
	})(React.BaseComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	React.BaseComponent=__webpack_require__(5);
	React.registerModule=__webpack_require__(6);
	module.exports=React;
	
	console.log("basecomponent",__webpack_require__(5).prototype);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactBrowserComponentMixin = __webpack_require__(14); //BUFIX (попробывать изменить register module)
	...
	BaseComponent.applyMixins(ReactBrowserComponentMixin);//BUFIX (попробывать изменить register module)
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var ReactDescriptor = __webpack_require__(15);
	var ReactDescriptorValidator = __webpack_require__(16);
	...
	function createComponent(Constructor){
	    ...
	    for (var methodName in ReactCompositeComponent.ReactCompositeComponentInterface) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *  Copy code from https://github.com/facebook/react/blob/master/src/core/ReactCompositeComponent.js
	 *
	 *  Служит для экспорта недоступных функкций ReactJS, является полной копией ReactCompositeComponent.js
	 *  дополненной экспортом из библиотеки
	 */
	...
	var mixInto = __webpack_require__(32);
	...
	module.exports={
	    ...
	    ReactCompositeComponentBase:ReactCompositeComponentBase,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getReactRootElementInContainer = __webpack_require__(41);
	var instantiateReactComponent = __webpack_require__(29);
	var invariant = __webpack_require__(13);
	var shouldUpdateReactComponent = __webpack_require__(35);
	var warning = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mergeInto = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var copyProperties = __webpack_require__(116);
	var keyOf = __webpack_require__(82);
	var invariant = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var accumulate = __webpack_require__(122);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * distributed under the License is distributed on an "AS IS" BASIS,
	 * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
	 * See the License for the specific language governinmo permissions and
	 * limitations under the License.
	 *
